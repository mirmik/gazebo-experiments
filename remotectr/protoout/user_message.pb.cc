...
class JointTorqueDefaultTypeInternal {
 public:
  ::PROTOBUF_NAMESPACE_ID::internal::ExplicitlyConstructed<JointTorque> _instance;
...
static void InitDefaultsscc_info_JointTorque_user_5fmessage_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;

  {
    void* ptr = &::user_messages::msgs::_JointTorque_default_instance_;
    new (ptr) ::user_messages::msgs::JointTorque();
    ::PROTOBUF_NAMESPACE_ID::internal::OnShutdownDestroyMessage(ptr);
  }
  ::user_messages::msgs::JointTorque::InitAsDefaultInstance();
}

::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_JointTorque_user_5fmessage_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_JointTorque_user_5fmessage_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_user_5fmessage_2eproto[3];
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_user_5fmessage_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  0,
  ~0u,
  PROTOBUF_FIELD_OFFSET(::user_messages::msgs::JointTorque, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::user_messages::msgs::JointTorque, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::user_messages::msgs::JointTorque, name_),
  PROTOBUF_FIELD_OFFSET(::user_messages::msgs::JointTorque, torque_),
  0,
  ~0u,
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  { 18, 25, sizeof(::user_messages::msgs::JointTorque)},
};
...
static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  ...
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::user_messages::msgs::_JointTorque_default_instance_),
};
...
const char descriptor_table_protodef_user_5fmessage_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "ate\"+\n\013JointTorque\022\014\n\004name\030\001 \002(\t\022\016\n\006torq"
  "ue\030\002 \003(\001"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_user_5fmessage_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_user_5fmessage_2eproto_sccs[3] = {
  &scc_info_JointState_user_5fmessage_2eproto.base,
  &scc_info_JointStateArray_user_5fmessage_2eproto.base,
  &scc_info_JointTorque_user_5fmessage_2eproto.base,
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_user_5fmessage_2eproto = {
  false, false, descriptor_table_protodef_user_5fmessage_2eproto, "user_message.proto", 208,
  &descriptor_table_user_5fmessage_2eproto_once, descriptor_table_user_5fmessage_2eproto_sccs, descriptor_table_user_5fmessage_2eproto_deps, 3, 0,
  schemas, file_default_instances, TableStruct_user_5fmessage_2eproto::offsets,
  file_level_metadata_user_5fmessage_2eproto, 3, file_level_enum_descriptors_user_5fmessage_2eproto, file_level_service_descriptors_user_5fmessage_2eproto,
};
...
class JointTorque::_Internal {
 public:
  using HasBits = decltype(std::declval<JointTorque>()._has_bits_);
  static void set_has_name(HasBits* has_bits) {
    (*has_bits)[0] |= 1u;
  }
  static bool MissingRequiredFields(const HasBits& has_bits) {
...
JointTorque::JointTorque(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  : ::PROTOBUF_NAMESPACE_ID::Message(arena),
  torque_(arena) {
  SharedCtor();
  RegisterArenaDtor(arena);
  // @@protoc_insertion_point(arena_constructor:user_messages.msgs.JointTorque)
}
JointTorque::JointTorque(const JointTorque& from)
  ...
  // @@protoc_insertion_point(copy_constructor:user_messages.msgs.JointTorque)
}

void JointTorque::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_JointTorque_user_5fmessage_2eproto.base);
  name_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}

JointTorque::~JointTorque() {
  // @@protoc_insertion_point(destructor:user_messages.msgs.JointTorque)
  SharedDtor();
  _internal_metadata_.Delete<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>();
}
...
void JointTorque::ArenaDtor(void* object) {
  JointTorque* _this = reinterpret_cast< JointTorque* >(object);
  (void)_this;
}
void JointTorque::RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena*) {
}
...
// @@protoc_insertion_point(message_clear_start:user_messages.msgs.JointTorque)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
const char* JointTorque::_InternalParse(const char* ptr, ::PROTOBUF_NAMESPACE_ID::internal::ParseContext* ctx) {
#define CHK_(x) if (PROTOBUF_PREDICT_FALSE(!(x))) goto failure
  _Internal::HasBits has_bits{};
  ::PROTOBUF_NAMESPACE_ID::Arena* arena = GetArena(); (void)arena;
  while (!ctx->Done(&ptr)) {
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ...
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParser(str, ptr, ctx);
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "user_messages.msgs.JointTorque.name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* JointTorque::_InternalSerialize(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:user_messages.msgs.JointTorque)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      this->_internal_name().data(), static_cast<int>(this->_internal_name().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::SERIALIZE,
      "user_messages.msgs.JointTorque.name");
    target = stream->WriteStringMaybeAliased(
        1, this->_internal_name(), target);
  }

  // repeated double torque = 2;
  for (int i = 0, n = this->_internal_torque_size(); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteDoubleToArray(2, this->_internal_torque(i), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:user_messages.msgs.JointTorque)
  return target;
}

size_t JointTorque::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:user_messages.msgs.JointTorque)
  size_t total_size = 0;
  ...
  // repeated double torque = 2;
  {
    ...
    size_t data_size = 8UL * count;
    total_size += 1 *
                  ::PROTOBUF_NAMESPACE_ID::internal::FromIntSize(this->_internal_torque_size());
    total_size += data_size;
  }
...
void JointTorque::MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_merge_from_start:user_messages.msgs.JointTorque)
  GOOGLE_DCHECK_NE(&from, this);
  const JointTorque* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<JointTorque>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:user_messages.msgs.JointTorque)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:user_messages.msgs.JointTorque)
    MergeFrom(*source);
  }
}

void JointTorque::MergeFrom(const JointTorque& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:user_messages.msgs.JointTorque)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
void JointTorque::CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) {
// @@protoc_insertion_point(generalized_copy_from_start:user_messages.msgs.JointTorque)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:user_messages.msgs.JointTorque)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata JointTorque::GetMetadata() const {
  return GetMetadataStatic();
}
...
template<> PROTOBUF_NOINLINE ::user_messages::msgs::JointTorque* Arena::CreateMaybeMessage< ::user_messages::msgs::JointTorque >(Arena* arena) {
  return Arena::CreateMessageInternal< ::user_messages::msgs::JointTorque >(arena);
}

...
template<> ::user_messages::msgs::JointTorque* Arena::CreateMaybeMessage<::user_messages::msgs::JointTorque>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace user_messages {
namespace msgs {
...
class JointTorque PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:user_messages.msgs.JointTorque) */ {
 public:
  inline JointTorque() : JointTorque(nullptr) {};
  virtual ~JointTorque();
  ...
  inline void Swap(JointTorque* other) {
    if (other == this) return;
    if (GetArena() == other->GetArena()) {
      InternalSwap(other);
    } else {
  ...
  void UnsafeArenaSwap(JointTorque* other) {
    if (other == this) return;
    GOOGLE_DCHECK(GetArena() == other->GetArena());
    InternalSwap(other);
  }
  ...
  inline JointTorque* New() const final {
    return CreateMaybeMessage<JointTorque>(nullptr);
  }

  JointTorque* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
    return CreateMaybeMessage<JointTorque>(arena);
  }
  void CopyFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  void MergeFrom(const ::PROTOBUF_NAMESPACE_ID::Message& from) final;
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "user_messages.msgs.JointTorque";
  }
  protected:
  explicit JointTorque(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  private:
  static void ArenaDtor(void* object);
  inline void RegisterArenaDtor(::PROTOBUF_NAMESPACE_ID::Arena* arena);
  public:
  ...
  // @@protoc_insertion_point(class_scope:user_messages.msgs.JointTorque)
 private:
  class _Internal;
...
// required string name = 1;
inline bool JointTorque::_internal_has_name() const {
  bool value = (_has_bits_[0] & 0x00000001u) != 0;
  return value;
}
inline bool JointTorque::has_name() const {
  return _internal_has_name();
}
inline void JointTorque::clear_name() {
  name_.ClearToEmpty(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
  _has_bits_[0] &= ~0x00000001u;
}
inline const std::string& JointTorque::name() const {
  // @@protoc_insertion_point(field_get:user_messages.msgs.JointTorque.name)
  return _internal_name();
}
inline void JointTorque::set_name(const std::string& value) {
  _internal_set_name(value);
  // @@protoc_insertion_point(field_set:user_messages.msgs.JointTorque.name)
}
inline std::string* JointTorque::mutable_name() {
  // @@protoc_insertion_point(field_mutable:user_messages.msgs.JointTorque.name)
  return _internal_mutable_name();
}
inline const std::string& JointTorque::_internal_name() const {
  return name_.Get();
}
inline void JointTorque::_internal_set_name(const std::string& value) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value, GetArena());
}
inline void JointTorque::set_name(std::string&& value) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:user_messages.msgs.JointTorque.name)
}
inline void JointTorque::set_name(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000001u;
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:user_messages.msgs.JointTorque.name)
}
inline void JointTorque::set_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:user_messages.msgs.JointTorque.name)
}
inline std::string* JointTorque::_internal_mutable_name() {
  _has_bits_[0] |= 0x00000001u;
  return name_.Mutable(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArena());
}
inline std::string* JointTorque::release_name() {
  // @@protoc_insertion_point(field_release:user_messages.msgs.JointTorque.name)
  if (!_internal_has_name()) {
    return nullptr;
  }
  _has_bits_[0] &= ~0x00000001u;
...
inline void JointTorque::set_allocated_name(std::string* name) {
  if (name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  } else {
    _has_bits_[0] &= ~0x00000001u;
  ...
  name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:user_messages.msgs.JointTorque.name)
}
inline std::string* JointTorque::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:user_messages.msgs.JointTorque.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  _has_bits_[0] &= ~0x00000001u;
  return name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void JointTorque::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
    _has_bits_[0] |= 0x00000001u;
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:user_messages.msgs.JointTorque.name)
}

// repeated double torque = 2;
inline int JointTorque::_internal_torque_size() const {
  return torque_.size();
}
inline int JointTorque::torque_size() const {
  return _internal_torque_size();
}
inline void JointTorque::clear_torque() {
  torque_.Clear();
}
inline double JointTorque::_internal_torque(int index) const {
  return torque_.Get(index);
}
inline double JointTorque::torque(int index) const {
  // @@protoc_insertion_point(field_get:user_messages.msgs.JointTorque.torque)
  return _internal_torque(index);
}
inline void JointTorque::set_torque(int index, double value) {
  torque_.Set(index, value);
  // @@protoc_insertion_point(field_set:user_messages.msgs.JointTorque.torque)
}
inline void JointTorque::_internal_add_torque(double value) {
  torque_.Add(value);
}
inline void JointTorque::add_torque(double value) {
  _internal_add_torque(value);
  // @@protoc_insertion_point(field_add:user_messages.msgs.JointTorque.torque)
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
JointTorque::_internal_torque() const {
  return torque_;
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >&
JointTorque::torque() const {
  // @@protoc_insertion_point(field_list:user_messages.msgs.JointTorque.torque)
  return _internal_torque();
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
JointTorque::_internal_mutable_torque() {
  return &torque_;
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedField< double >*
JointTorque::mutable_torque() {
  // @@protoc_insertion_point(field_mutable_list:user_messages.msgs.JointTorque.torque)
